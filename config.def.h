...
static const char *fonts[]          = { "Source Code Pro:size=18", "Font Awesome 6 Solid:size=18" };
...
static const char col_rosewood[]    = "#9E4244";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_gray1, col_gray2 },
	[SchemeSel]  = { col_gray4, col_rosewood,  col_gray1  },
};
